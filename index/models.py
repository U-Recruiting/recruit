...
class UserInfo(models.Model):
    ...
    school = models.CharField('学校', max_length=100, default=None, null=True)
...
class EducationExp(models.Model):
    ...
    start_date = models.DateTimeField('起始时间', null=True)
    end_date = models.DateTimeField('终止时间', null=True)
    education = models.CharField('学历', max_length=50, default=None, null=True) ##待改成char
...
class PositionResumeStatus(models.Model):
    ...
    status = models.CharField('状态', max_length=20, default=None, null=True) #received,notified,passed,refused,filter,
    address = models.CharField('面试地址', max_length=200, default=None, null=True)
    datetime = models.DateTimeField('面试时间', default=None, null=True)
