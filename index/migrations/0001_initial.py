# Generated by Django 2.1.2 on 2018-11-12 18:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='index.City', verbose_name='所属城市')),
            ],
        ),
        migrations.CreateModel(
            name='Dynamic_Org',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='index.Job_Label1', verbose_name='父标签ID')),
            ],
        ),
        migrations.CreateModel(
            name='Job_Label3',
            fields=[
                ...
                ('parent', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='index.Job_Label2', verbose_name='父标签ID')),
            ],
        ),
        migrations.CreateModel(
            name='OrgInfo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default=None, max_length=20, verbose_name='公司名称')),
                ('avatar', models.CharField(default=None, max_length=50, verbose_name='公司图标')),
                ('type', models.CharField(default=None, max_length=20, verbose_name='公司类型')),
                ('phase', models.CharField(default=None, max_length=50, verbose_name='公司所在阶段')),
                ('desc', models.CharField(default=None, max_length=500, verbose_name='公司描述')),
                ('scale', models.IntegerField(verbose_name='公司人数')),
                ('url', models.CharField(default=None, max_length=20, verbose_name='公司网站')),
                ...
                ('tags', models.CharField(default=None, max_length=200, verbose_name='公司标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_datetime', models.DateTimeField(default=None, verbose_name='创建时间')),
                ('org', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='index.OrgInfo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='index.PositionInfo')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectExp',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('edu_exp', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='index.EducationExp')),
                ('project_exp', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='index.ProjectExp')),
                ('user', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
